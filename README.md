...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-soft-1750158807) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-soft-1750158807.git
$ cd django-soft-1750158807
```
